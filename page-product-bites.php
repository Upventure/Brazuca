...
<?php get_header('');?>
   ...
   <div class="background-image2 back-home slider-coffee background-image-bites" style="height:500px">
...
<div class="advertisements">
  ...
  <div class="wrapper-white-section-section-50-50">
     ...
     <div class="Bites-image">      </div>

             <div class="text-white-section">
               <h1>Pão de queijo </h1><p>
...
<div class="advertisements">
        <div class='referal-advertisement bites-full-section'>
            <div class='content mask-layer' style="background-color:rgba(152, 139, 24, 0.27);">
                ...
                <div class='summary summary-extra' style="border: solid  2px whitesmoke"><h1 style="color:white">  Oorsprong Pão de queijo</h1><p style="color:white">
